...
/**
 * Класс, позволяющий узнать, в каком состоянии находится пользователь (какая команда выполняется)
 * для последующей обработки его пороса. Необходим, когда взаимодействие с пользователем происходит
 * в форме диалога.
 */
public class UserContext {
    ...
    /** Возвращает {@link #state состояние пользователя}. */
    public UserState getState() {
        return state;
    }

    /** Возвращает {@link #stateNum номер состояния пользователя}. */
